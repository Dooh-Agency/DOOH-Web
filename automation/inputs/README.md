...
La carga principal se realiza en el [Formulario de inputs](https://docs.google.com/spreadsheets/d/1wIibWzTBJTPbJ5BOWPVTSmfrnGSRqPQ5vbh0rUqn9_0/edit?usp=drivesdk). Esta carpeta conserva los inputs aportados localmente para una tanda: trabajos, imágenes, noticias de interés para DOOH, referencias y cualquier indicación de post. Cada input debe indicar:

- fecha;
- cliente o proyecto relacionado, si aplica;
- fuente o enlace a la carpeta de Google Drive;
